...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/cc264fcc-0dfc-44ea-afb9-3965da7df9ba";
      fsType = "btrfs";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/F137-3E77";
      fsType = "vfat";
      options = [ "fmask=0022" "dmask=0022" ];
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/6e86b55f-0266-4515-a22a-3a6472c9da3b"; }
    ];
